...
public class App {
  ...
  private static SolrQuery getSolrQuery(String searchTerm) {
    ...
    if (StringUtils.isNotEmpty(APP_PROPERTIES.getPhraseFields())) {
      query.set("pf", APP_PROPERTIES.getPhraseFields());
    }
    ...
    if (StringUtils.isNotEmpty(APP_PROPERTIES.getPhraseSlop())) {
      query.set("ps", APP_PROPERTIES.getPhraseSlop());
    }
